i[跳转至](https://101.lug.ustc.edu.cn/Ch09/#shell)
...
现实中的 ports 文件可以从 [https://mirrors.ustc.edu.cn/freebsd-ports/ports.tar.gz](https://mirrors.ustc.edu.cn/freebsd-ports/ports.tar.gz) 下载解压得到。

注意：少量 `distinfo` 文件的 SHA256 对应行最后会有多余的空格或制表符，需要妥善处理。

[跳转至](https://101.lug.ustc.edu.cn/Ch09/supplement/#supplement)
